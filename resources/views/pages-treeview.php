...
<head>
        ...
        <link href="assets/libs/listree/listree.min.css" rel="stylesheet" type="text/css" />
         <!-- App css -->
    ...
    <body>
        ...
        <script src="assets/libs/listree/listree.umd.min.js"></script>
        <script src="assets/JS/pages/tree.init.php"></script>
        <script src="assets/js/app.js"></script>
    </body>
    <!--end body-->

pages-treeview 15:07:21 GMT -->
</html>