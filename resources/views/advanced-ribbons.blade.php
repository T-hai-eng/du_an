                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <img src="assets/images/extra/dashboards/dastyle.jpg" alt="user" height="150" class="align-self-center shadow-sm mb-3 mb-lg-0">
                                        </div><!--end col-->
                                        <div class="col align-self-center">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm">Live Priview</a> 
                                            <a href="#" class="btn btn-outline-secondary btn-sm">Download Now</a> 
                                        </div><!--end col-->
                                    </div> <!--end row-->               
                                </div><!--end card-body--> 
                            </div><!--end card--> 
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <img src="assets/images/extra/dashboards/crovex.jpg" alt="user" height="150" class="align-self-center shadow-sm mb-3 mb-lg-0">
                                        </div><!--end col-->
                                        <div class="col align-self-center">
                            ...
                            <div class="card">
                                <div class="card-body">
                                   <div class="ribbon1 rib1-danger">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <img src="assets/images/extra/dashboards/metrica.jpg" alt="user" height="150" class="align-self-center mb-3 shadow-sm mb-lg-0">
                                        </div><!--end col-->
                                        <div class="col align-self-center">
                            ...
                            <div class="card">
                                <div class="card-body">
                                   <div class="ribbon1 rib1-danger">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <img src="assets/images/extra/dashboards/frogetor.jpg" alt="user" height="150" class="align-self-center mb-3 shadow-sm mb-lg-0">
                                        </div><!--end col-->
                                        <div class="col align-self-center">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <img src="assets/images/extra/dashboards/dastyle.jpg" alt="user" height="150" class="align-self-center mb-3 shadow-sm mb-lg-0">
                                        </div><!--end col-->
                                        <div class="col align-self-center">
                                            <p class="font-18 fw-semibold mb-2">Dastyle - Admin & Dashboard Template</p>
                                            <p class="text-muted">Dastyle is a Bootstrap admin dashboard, 
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <img src="assets/images/extra/dashboards/crovex.jpg" alt="user" height="150" class="align-self-center mb-3 shadow-sm mb-lg-0">
                                        </div><!--end col-->
                                        <div class="col align-self-center">
                                            <p class="font-18 fw-semibold mb-2">Crovex - Admin & Dashboard Template</p>
                                            <p class="text-muted">Crovex is a Bootstrap admin dashboard, 
