...
<!-- Mirrored from mannatthemes.com/rizz/default/ecommerce-refunds.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Nov 2024 15:06:57 GMT -->
<head>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="ecommerce-order-details.html" class="text-secondary"><i class="fa-solid fa-circle-info me-1"></i> Order Detail</a>  
                                        </div><!--end col-->
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
