                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarDashboards">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php">Analytics</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="ecommerce-index.php">Ecommerce</a>
                                        </li><!--end nav-item-->
                                    </ul><!--end nav-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarIcons">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="icons-lineawesome.php">Line Awesome</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="icons-icofont.php">Icofont</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="icons-iconoir.php">Iconoir</a>
                                        </li><!--end nav-item-->
                                    </ul><!--end nav-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarPages">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages-notifications.php">Notifications</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarAuthentication">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-maintenance.php">Maintenance</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                            ...
                            <div class="border-dashed border-theme-color rounded">
                                <div class="card bg-light ">
                                    <div class="card-body border-dashed-bottom border-theme-color">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/users/avatar-1.jpg" alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div id="project-list-start" class="p-3 pt-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/meta.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/nextjs.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/reactjs.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/chatgpt.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                            ...
                            <div class="border-dashed border-theme-color rounded">
                                <div class="card bg-light ">
                                    <div class="card-body border-dashed-bottom border-theme-color">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/users/avatar-8.jpg" alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div id="project-list-center" class="p-3 pt-0">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/nodejs.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/gitlab.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/vue.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                            ...
                            <div class="border-dashed border-theme-color rounded">
                                <div class="card bg-light ">
                                    <div class="card-body border-dashed-bottom border-theme-color">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/users/avatar-7.jpg" alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div id="project-list-end" class="p-3 pt-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/symfony.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/slack.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/logos/lang-logo/python.png" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
