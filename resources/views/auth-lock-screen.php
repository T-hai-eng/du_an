                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">                                    
                                    <form class="my-4" action="https://mannatthemes.com/rizz/default/index.php">            
                                    ...
                                    <div class="text-center  mb-2">
                                        <p class="text-muted">Not you ? return  <a href="auth-register.php" class="text-primary ms-2">Sign in here</a></p>
                                    </div>
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div><!--end col-->
